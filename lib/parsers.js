...
exports.parseDateFromPostgres = function (str,datestyle,OID) {
    if (exports.DEBUG > 0) {
        util.debug("parsing string: "+ str + " with datestyle: " + datestyle + " with OID: " + OID);
    }
  ...
  if (!(style in date_regex) && (exports.DEBUG > 0)) {
    ...
    util.debug("Error datestyle not implemented: " + style);
  }
